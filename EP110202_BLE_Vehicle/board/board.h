...
// #define BOARD_LLWU_PIN_ENABLE_BITMAP ( 1<<10 )   //PC2, LLWU_P10
// #define BOARD_LLWU_PIN_ENABLE_BITMAP ( 1<<12 ) //PC4(CAN_RX), LLWU_P12

/* PC2(LLWU_P10), PC4(CAN_RX:LLWU_P12),PC16(NFCIRQ:LLWU_P0) */  
#define BOARD_LLWU_PIN_C2_BITMAP        ( 1<<10 )
#define BOARD_LLWU_PIN_C4_BITMAP        ( 1<<12 )
#define BOARD_LLWU_PIN_C16_BITMAP       ( 1<<0 )
#define BOARD_LLWU_PIN_B0_BITMAP        ( 1<<8 )

#if PTB0_IRQ_PIN
#define BOARD_LLWU_PIN_ENABLE_BITMAP    (BOARD_LLWU_PIN_C4_BITMAP|BOARD_LLWU_PIN_B0_BITMAP)   
#else
#define BOARD_LLWU_PIN_ENABLE_BITMAP    (BOARD_LLWU_PIN_C2_BITMAP|BOARD_LLWU_PIN_C4_BITMAP|BOARD_LLWU_PIN_C16_BITMAP)  
//#define BOARD_LLWU_PIN_ENABLE_BITMAP    (BOARD_LLWU_PIN_C2_BITMAP|BOARD_LLWU_PIN_C16_BITMAP)  
#endif
