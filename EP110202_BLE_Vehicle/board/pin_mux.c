...
// //
// //    PORT_SetPinMux(PORTB, PIN0_IDX, kPORT_MuxAlt8);            /* PORTB0 (pin 16) is configured as CAN0_TX */
// //    PORT_SetPinMux(PORTB, PIN1_IDX, kPORT_MuxAlt8);            /* PORTB1 (pin 17) is configured as CAN0_RX */

// 	CLOCK_EnableClock(kCLOCK_PortC);                           /* Port C Clock Gate Control: Clock enabled */

// 	PORT_SetPinMux(PORTC, PIN3_IDX, kPORT_MuxAlt9);            /* PORTC3 (pin 39) is configured as CAN0_TX */
// 	PORT_SetPinMux(PORTC, PIN4_IDX, kPORT_MuxAlt9);            /* PORTC4 (pin 40) is configured as CAN0_RX */
...
//     GPIO_PinInit(GPIOB, 0u, &(gpio_pin_config_t){kGPIO_DigitalOutput, 0U});
