...
void uds_cmd_diag(u8* data,u16 length)
{
    ...
    diagTag = core_dcm_readBig16(data+1U);
    ...
    case DIAG_TAG_WRITE_ANCHOR_SN:
        uds_ctx.gBuffer[0U] = UDS_ERR_CODE_SUCCESS;
        break;  
    case DIAG_TAG_UWB_SESSION_CTRL:
        obdUWBSessionCtrl = data[3];
        ble_ccc_send_evt(OBD_CTRL_UWB_SESSION,0U,NULL,0U);
        return;     
