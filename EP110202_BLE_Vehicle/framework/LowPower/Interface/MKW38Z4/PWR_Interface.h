...
typedef  union
{
    ...
    struct
    {
        ...
        uint8_t FromSwReset      :1;  /* Comming from SW Reset */
        uint8_t FromRtcAlarm     :1;
        uint8_t FromRtcSeconds   :1;
        
        uint8_t FromCan          :1;  /* Wakeup by CAN RX */
        uint8_t FromNFCIrq       :1;  /* Wakeup by NFC IRQ PIN */
    } Bits;
